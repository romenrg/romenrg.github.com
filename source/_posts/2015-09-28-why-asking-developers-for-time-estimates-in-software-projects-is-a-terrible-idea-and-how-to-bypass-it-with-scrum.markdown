...
So, at this point, as a manager you can [assume risks by doing a fixed-price contract](http://blog.salsitasoft.com/why-we-dont-do-fixed-price-software-projects/) with your customer based on more-than-likely-wrong time estimates. But if you do so, don't blame developers when deadlines are not met. If you have a team of professional and commited developers, they will be doing their best all the time, trying to do things as quickly as they can (as [@dhh](https://twitter.com/dhh) says, [ASAP is implied](https://twitter.com/dhh/status/584745462445518848)). Sadly, too many times I have seen managers using the whip with to make developers achieve the impossible. At the end, the imposible is not achieved, software quality goes down because of the rush (causing more delays due to constant bugfixing and poor code-maintainability), team morale is almost cero, everyone suffers burnout and the customer gets angry. Nobody wins.

Even if you use fixed-price contracts (or <em>"fixed-everything"</em> contracts), the approach I will describe below will help you to minimize problems, by following an iterative and incremental development process. With this approach, your team will always work in the most important features for the customer, releasing an incremental versions of the product every few weeks. By doing this, you will always have working software to ship to your customer. Showing the incremental releases to your customer will be up to you, but with this approach, when the deadline arrives and the project is not finished, at least the X more important features will be developed and working software will be available. Moreover, if you involve the customer by having a meetings with her every time a new incremental release is built, she will probably provide very useful feedback, rely more on you and you will probably be able to negotiate contract changes much more easily.
...
One great advantage of this method is that, since you can re-prioritize or update the Product Backlog at any moment, you will be able to know how does any change affect the timing of the project. And best of all, you will have really accurate time estimates, while improving the efficacy and efficiency of the team, keeping its morale high and reducing stress.

Moreover, this solution contributes to improve business-engineering relationship and trust; improve software quality and reduce costs in the long-run. Besides, if you involve customers in the process, customer relationships and trust may improve considerably; making it easier for both parties to deal with change, preventing many deadline-related conflicts.
